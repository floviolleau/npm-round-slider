...
(function ($, window, undefined) {
    ...
    RoundSlider.prototype = {
        ...
        _processStepByValue: function (value) {
            ...
            var remain = (value - this.options.min) % step;
            var currVal = value - remain;
            var nextVal = this._limitValue(currVal + step);
            var preVal = this._limitValue(currVal - step);
